...
query="project = ASHTAN AND status in (Assigned, Done, \"In Dev\", \"In Progress\", \"In Review\", \"In Test\", \"Security Approved\", \"Security Review\", \"To Do\", \"Backlog\")"


url = "http://ashtan21.atlassian.net/rest/api/2/search"

auth = HTTPBasicAuth("jhaashish21@gmail.com", "zt4n9nzx1qOWhNLfAgFU903E")
